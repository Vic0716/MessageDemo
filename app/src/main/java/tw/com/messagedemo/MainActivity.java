...
public class MainActivity extends AppCompatActivity {
    ...
    private Button tostbtn,snackbtn,alterbtn1,alterbtn2,alterbtn3,notifybtn;
    ...
    private void findViews(){
        tostbtn = findViewById(R.id.toastbtn);
        ...
        snackbtn.setOnClickListener(v -> {
            ...
            //一般型
            //Snackbar.make(v,"舉舉重世界第一",Snackbar.LENGTH_SHORT).show();
        ...
        notifybtn.setOnClickListener(v -> {
            ...
            NotifyMessage("舉重第一","美式買一送一","7-11及全家");
